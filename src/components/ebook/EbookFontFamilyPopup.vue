<template>
 <div class="font-family-popup" v-show="fontFamilyVisible">
   ...
   <div class="font-family-popup-list">
     <div class="font-family-list-item" v-for="(item,index) in fontFamilyList" :key="index" @click="setFontFamily(item.font)">
       <div class="font-family-list-item-text" :class="{'selected':item.font === defaultFontFamily}">{{item.font}}</div>
